  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="animate-fade-up">
        ...
        <p className="text-white/45 text-sm mt-1">Gerencie sua conta no CitizenPrep AI.</p>
      </div>
      ...
      >
        <div className="px-5 py-3" style={{ borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
          <p className="text-[10px] font-medium uppercase tracking-widest text-white/25">Conta</p>
        </div>
        <Link
          href="/reset-password"
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-white">Mudar senha</p>
            <p className="text-xs text-white/35 mt-0.5">Atualize sua senha de acesso</p>
          </div>
        </Link>
      </div>
